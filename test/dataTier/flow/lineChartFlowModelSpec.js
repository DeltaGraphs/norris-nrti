...
describe('LineChartFlowModel', function() {
    ...
    describe('#addRecord', function() {
        ...
        it('replaces an old record', function() {
            var flow1=new LineChartFlowModel({ID: 'flow1', maxItemsSaved: 3});
    ...
    describe('#updateProperties', function() {
        it('updated properties', function() {
            ...
            assert.deepEqual(updP,{'xKey':'temp','yKey':'press','xFormat':'toInt','yFormat':'toFloat','flowColor':'#FFFFFF','marker':'circle','area':true,'maxItems':4,'maxItemsSaved':50});
        });
    });
