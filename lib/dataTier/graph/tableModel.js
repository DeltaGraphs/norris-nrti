...
TableModel.prototype.updateProperties = function(params) {
	if (params !== undefined){
		...
		if(params.appearance!==undefined && typeof params.appearance) {
			if(params.appearance.horizontalGrid!==undefined && typeof params.appearance.horizontalGrid === 'object') {
				if(params.appearance.horizontalGrid.color !== undefined && typeof params.appearance.horizontalGrid.color === 'string' && FH.isHEX(params.appearance.horizontalGrid.color)) {
					this._appearance.horizontalGrid.color = params.appearance.horizontalGrid.color;
				}
				if(params.appearance.horizontalGrid.width !== undefined && typeof params.appearance.horizontalGrid.width === 'number') {
					this._appearance.horizontalGrid.width = params.appearance.horizontalGrid.width;
				}
			}
			if(params.appearance.verticalGrid!==undefined && typeof params.appearance.verticalGrid === 'object') {
				if(params.appearance.verticalGrid.color !== undefined && typeof params.appearance.verticalGrid.color === 'string' && FH.isHEX(params.appearance.verticalGrid.color)) {
					this._appearance.verticalGrid.color = params.appearance.verticalGrid.color;
				}
				if(params.appearance.verticalGrid.width !== undefined && typeof params.appearance.verticalGrid.width === 'number') {
