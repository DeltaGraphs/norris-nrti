...
TableModel.prototype.updateProperties = function(params) {
	if (params !== undefined){
		...
		if(params.sort!==undefined && params.sort.column!==undefined && params.sort.ordering!==undefined && typeof params.sort.column === 'array' && typeof params.sort.ordering === 'array'){
			var check=true;
