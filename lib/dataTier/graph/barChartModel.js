...
function BarChartModel(params) {
	...
	console.log('barChartModel-before parent constructor');
	this.parent.constructor.call(this, params);
	console.log('barChartModel-after parent constructor');
	...
	this._flows=[];
	console.log('barChartModel-before updateProperties');
	this.updateBarProperties(params);
	console.log('barChartModel-after updateProperties');
}
...
BarChartModel.prototype.updateBarProperties = function(params) {
	console.log('barChartModel-updateProperties');
	if (params !== undefined){
