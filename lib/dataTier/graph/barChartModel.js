...
var BarChartFlowModel = require('../flow/barChartFlowModel.');

BarChartModel.prototype = GraphModel;
BarChartModel.prototype.constructor = BarChartModel;
BarChartModel.prototype.parent = GraphModel;
...
BarChartModel.prototype.updateRecord = function(flowID, index, newRecord) {
	...
	if(filteredFlows.length > 0) {
		...
		flow.updateRecord(index, newRecord); //HANDLE THE FAILURE
	}
	//HANDLE THE FAILURE
};
