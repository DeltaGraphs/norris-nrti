...
MapChartFlowModel.prototype.getProperties = function(){
	...
	prop.marker={
		type: this._marker.type,
		shape: this._marker.shape,
		icon: this._marker.icon,
		text: this._marker.text,
	};
	prop.trace={
		type: this._trace.type,
		coordinates: this._trace.coordinates
	};
	prop.maxItems=this._maxItems=50;
	prop.maxItemsSaved=this._maxItemsSaved=500;
	return prop;
};
