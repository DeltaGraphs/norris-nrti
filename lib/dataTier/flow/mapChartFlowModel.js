...
function MapChartFlowModel(params) {
	...
	this._longitudeFormat=null;
	this._latitudeFormat=null;
...
MapChartFlowModel.prototype.deleteRecord = function(ID_index){
	if (typeof ID_index==='string' && ID_index.indexOf(this._ID) !== -1) {
		var records=this._records.length;
		var i=0;
		var found=false;
		while (i<records && (!found)){
