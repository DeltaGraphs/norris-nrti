...
function Routes(app, norrisNamespace) {
	if(app===undefined || norrisNamespace===undefined || app.lazyrouter===undefined || typeof norrisNamespace !=='string' || norrisNamespace.length < 2 || norrisNamespace.indexOf('/')!==0) {
		return;
	}
    ...
    app.use(this._norrisNamespace, this._app);
}
