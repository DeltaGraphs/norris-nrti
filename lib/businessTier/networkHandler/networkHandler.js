...
NetworkHandler.prototype.createSocket = function(namespace,attachedObject,onConnectionEvent) {
	var sock=new Socket(this._io,namespace,attachedObject,onConnectionEvent);
