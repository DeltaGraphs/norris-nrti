...
function NetworkHandler(app,io,norrisNamespace){
	if(app===undefined || io===undefined || norrisNamespace===undefined ||
		typeof app !== 'function' || app.prototype.costructor !== 'Express' ||
		typeof io !== 'object' || io.prototype.costructor !== 'SocketIO' ||
		typeof norrisNamespace !== 'object' || norrisNamespace.length<2
		){
