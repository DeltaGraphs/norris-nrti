...
MapChartFlow.prototype.addRecord = function(record){
	...
	if (res!==133 && this._dataFlow.getRecordByID(res)._norrisIsValid){
...
MapChartFlow.prototype.deleteRecord = function(ID){
	var record=this._dataFlow.getRecordByID(ID);
	if (record!==135){
		...
		this._dataFlow.deleteRecord(ID);
		return true;
	}
	return 135;
};
...
MapChartFlow.prototype.updateRecord = function(ID, record){
	var oldValid=this._dataFlow.getRecordByID(ID)._norrisIsValid;
	var res=this._dataFlow.updateRecord(ID, record);
	var newValid=this._dataFlow.getRecordByID(ID)._norrisIsValid;
	if (res===true ){
