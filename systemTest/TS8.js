...
var TS=function(mapChart){
	...
	var IDs=mapChartFlow1.updateMovie([
		{'0':0,'1':45.42533493042,'2':11.902134895325},
		{'0':1,'1':45.43533493042,'2':11.902134895325},
		{'0':2,'1':45.41533493042,'2':11.902134895325},
		{'0':3,'1':45.41933493042,'2':11.902134895325},
		{'0':4,'1':45.42233493042,'2':11.902134895325}
	]);
	...
	var repeat=function(){
		...
		mapChart.updateRecord('flow1', IDs[index], {'0':index,'1':45.41+(Math.random() * 0.01),'2':11.9+(Math.random() * 0.01)});
		mapChart.addRecord('flow2', {'0':index,'1':45.44+(Math.random() * 0.01),'2':11.93+(Math.random() * 0.01)});
