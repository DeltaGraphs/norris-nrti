...
var TS=function(table){
	...
	var repeat=function(){
		...
		table.addRecord('flow2', {'0':Math.floor((Math.random() * 10) + 1), '1':Math.floor((Math.random() * 10) + 1), '2':Math.floor((Math.random() * 10) + 1), appearance:[{bg: '#FFFFAA',text: '#000000'},{bg: '#FFFFAA',text: '#000000'},{bg: '#FFFFAA',text: '#000000'}]});
		index++;
	};
