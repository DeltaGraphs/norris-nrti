        ...
        link: function(scope, element, attrs){
            ...
            scope.init = function(){
                ...
                if (scope.$parent.lineChart.getViewFinder() === true) {
                    ...
                    linechart = linechart + 'width="'+ scope.$parent.lineChart.getWidth() +'" height="'+ scope.$parent.lineChart.getHeight() +'"  height2="150" ';
                    ...
                    linechart = linechart + 'x="xFunction()" y="yFunction()" x2="xFunction()" y2="yFunction()" xaxisrotatelabels="-90" x2axisrotatelables="-90">';
                    linechart = linechart + '<svg></svg></nvd3-line-with-focus-chart>';
                } else {
                    linechart = '<nvd3-line-chart data="exampledData" nodata=" " id="'+ id +'" ';
                    linechart = linechart + 'showlegend="'+ legend +'" interactive="true" tooltips="'+ onPoint +'" ';
                    ...
                    linechart = linechart + 'x="xFunction()" y="yFunction()" xaxisrotatelabels="-90">';
